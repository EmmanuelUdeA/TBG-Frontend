const Policies = () => {
    return (
        <div className="justify-start w-screen flex-col items-center h-screen text-center mb-28 overflow-y-auto">
            <h2 className="text-2xl font-bold mb-5 bg-black text-yellow-50 w-full p-5">Privacy Policies</h2>
            <div className="flex flex-col justify-center items-center w-full">
                <h3 className="font-semibold text-4xl mb-4 h-10 w-full">E-COMMERCE SECURITY </h3>
                <p className="text-center w-1/2 h-auto my-3 ">Making payments through the Tripboysgang website is safe because:

                    Tripboysgang has maximum security measures. The process works on a secure server using the SSL (Secure Socket Layer) protocol. The secure server establishes a connection that ensures that it is only intelligible to the Customer's computer and the E-Commerce computer. In this way, by using the SSL protocol it is guaranteed:
                    ...
                    From www.Tripboysgang.com, Tripboysgang does not capture, store or transmit transactional data</p>

                <h3 className="font-semibold text-4xl mb-4 h-10 w-full">ACCESS TO Tripboysgang CONTENTS</h3>
                ...
                <h3 className="font-semibold text-4xl mb-4 h-10 w-full">INTELLECTUAL PROPERTY</h3>
                <p className="text-center w-1/2 h-auto my-3 ">Tripboysgang holds all rights to the content, design, layout and source code of this Web site and, in particular, to the photographs, images, logos, clothing designs, trademarks and trade names included in the Web site. These rights are protected by current legislation on intellectual property.
                    ...
                    Likewise, Tripboysgang shall not be liable under any circumstances in the event of:
                ...
                <h3 className="font-semibold text-4xl mb-4 h-10 w-full">INFORMATION PROCESSING POLICY
                </h3>
                <p className="text-center w-1/2 h-auto my-3 ">Tripboysgang SAS, a company identified as Tripboysgang, domiciled at Calle 43 No. 55a-76 in the city of Medellin and telephone +57 324 5769790, is responsible for the handling of personal data and will do so acting with criteria of confidentiality, security and restricted circulation.
                    ...
                    Rights as holder and specific procedures:
                    ...
                    Pursuant to the foregoing, the following persons are in charge of attending to requests, queries and claims:
                ...
                <h3 className="font-semibold text-4xl mb-4 h-10 w-full">Privacy Notice
                </h3>
                <p className="text-center w-1/2 h-auto my-3 ">
                    ...
                    The rights you have as owner of the data are:
