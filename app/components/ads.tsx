...
const Ads = () => {
    ...
    return (
        <div className={`flex flex-row h-10 w-screen justify-center items-center bg-black text-white fixed z-20 transition-transform duration-300 ${showAds ? 'transform translate-y-0' : 'transform -translate-y-10'}`}>
