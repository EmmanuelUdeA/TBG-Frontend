        ...
        <div className="justify-start w-screen flex-col items-center h-auto text-center mt-40 mb-16">
            ...
            <div className="flex flex-col justify-center items-center w-full h-auto">
                ...
                <p className="text-center w-1/2 h-auto my-3 ">{/*HOW TO MAKE AN EXCHANGE?
                    ...
                    Contact our WhatsApp line +57 324 5769790 or our email tripboysgang@gmail.com M-F from 9:00 am - 6:00 pm to coordinate the exchange process and the collection of your product.



                    Exchanges can be made by size (subject to availability).
                    If you want to exchange for another reference it is necessary that this has had the same value of the one you purchased (considering your discount).
                    If it is a totally different product than the one you purchased, the value of your purchase will be considered in your favor and you will be able to pay the excess for the new reference.

                    To make the return process, the product must be properly packaged. Use the same packaging in which you received the order or a different one that protects the product during the transportation process.



                    To make an exchange, the product must be in perfect condition, clean, unused, with tags and labels. Exchanges of products for personal use are not allowed (socks, caps, caps and other products for personal use).

                    The exchange of a product can be made up to thirty (30) days after your purchase (Invoice date).
                    ...
                    1. Once you contact us, we reserve the clothes you want.

                    2. We will schedule the pick up of your clothes to the address you give us, the value of the address you must assume.

                    3. When the clothes arrive we will verify that everything is ok and we will send you the new item. You will be responsible for the shipping cost to your home.

                    4. If you have to pay any surplus or you have any credit balance we will send you all the information to your email or WhatsApp.

                    5. If the clothes you sent us do not meet these conditions we can reserve the possibility of not making the exchange.



                    Important: if the carriers with which we have an agreement are not picking up packages in your area you can give us an alternative address or send us the clothes by your means, in this case tripboysgang® does not assume the shipping costs.

                    Exchanges do not apply when there are promotions in the store.
                    ...
                    To return a product under warranty the garment can be used, without tags and labels. Products will be guaranteed for 30 days from the date of purchase. The product must not be modified by the buyer or altered from its original state, it must also be in good condition and clean.



                    HOW TO MAKE A WARRANTY RETURN?

                    To make a warranty return of a product you purchased at www.tripboysgang.com



                    please contact our WhatsApp line +57 317 2493235 or our email servicioalcliente@weedgreen.com M-F from 9:00 am - 6:00 am and we will inform you about the warranty return you want to make, this will be done with the delivery of a coupon with a balance in pesos in your favor for the value of the defective garment, once it is received at the address you indicated. To make the redemption of this coupon, the value charged to the code ($) must be spent in a single transaction.



                    The product must be properly packaged. Use packaging that protects the product during the shipping process.
...
*/}                 Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam itaque labore a earum quae illum quidem, et dicta sint ipsa sapiente quasi incidunt porro eaque in deleniti rem unde voluptatibus.
                ...
                <p className="text-center w-1/2 h-auto my-3 ">{/*SHIPPING POLICY
                    ...
                    tripboysgang® delivers to most of the Colombian territory throughinterrapidisimo, which guarantees security and coverage, so that your purchase arrives to the address you want.

                    The delivery time of the products is approximately 5 to 7 working days for the cities of Bogota, Medellin, Cali, and major cities, up to 9 working days for other destinations. These times are subject to change according to promotional events or external to tripboysgang® as weather events and own carrier.

                    Delivery times

                    Delivery times begin to count from the confirmation of the payment of the purchase.

                    At the time of payment approval, you will receive an email with the payment confirmation.

                    Please note that:

                    * Deliveries cannot be made on an exact schedule.
                    * Deliveries may be delayed due to weather, landslides, traffic and other contractual issues reported by interrapidisimo.
                    * The product may be received and inspected by any person of legal age who lives or is present at the place of delivery, for which the signature of the carrier's guide will suffice.

                    In case you have any concerns with the shipment or the product has signs of damage or breakage in its packaging at the time of delivery, you should contact our WhatsApp line +57 324 5769790 or our email tripboysgang@gmail.com M-F from 9:00 am - 6:00.  Through our website www.tripboysgang.com in the 'Contact us' form.
