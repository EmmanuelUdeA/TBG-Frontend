        ...
        <div className="justify-center items-center w-screen h-autow-full h-screen bg-no-repeat bg-center bg-cover flex flex-col border-s ">
            <section className="w-1/2 h-5/6 flex flex-col justify-center items-center bg-white rounded-md ">
                ...
                <form className="w-full h-1/2 flex flex-col justify-center items-center">
                    ...
                    <label className="w-3/4 h-2 flex flex-row justify-start items-center mb-2 text-sm" htmlFor="password"> reply password</label>
                    <input className="w-3/4 h-1/5 flex flex-row justify-center item-center border-solid border mb-3 rounded-md" id="reply_password" name="password" type="password" />
