const Conditions = () => {
    return (
        <div className="justify-start w-screen flex-col items-center h-screen text-center mb-28 overflow-y-auto">
            <h2 className="text-2xl font-bold mb-5 bg-black text-yellow-50 w-full p-5">terms and conditions</h2>
            <div className="flex flex-col justify-center items-center w-full">
                <h3 className="font-semibold text-4xl mb-4 h-10 w-full"> RESTRICTIONS ON USE </h3>
                ...
                <h3 className="font-semibold text-4xl mb-4 h-10 w-full">ACCEPTANCE OF TERMS AND CONDITIONS                </h3>
                <p className="text-center w-1/2 h-auto my-3 ">By accessing and using the www.tripboysgang.com site you agree that purchases are subject to the Terms and Conditions published on the site, and all applicable laws shall govern and be interpreted in accordance with Colombian law.
                    ...
                    It is important to clarify that the shipping costs of the merchandise actually purchased may vary without prior notice, according to the commercial conditions of our logistics operators and/or courier companies, increases or variations beyond the control of tripboysgang®. </p>

                <h3 className="font-semibold text-4xl mb-4 h-10 w-full">PRIVACY POLICY</h3>
