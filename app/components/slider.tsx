...
const Slider = ({ nameColl, nameImg, handleBack, handleForward, actualItem, itemsLength, actualComponent, imgContClass, imgWidth, imgHeight }) => {
    return (
        <div className="w-screen flex flex-row h-screen bg-cover bg-no-repeat overflow-hidden justify-center items-center">
            ...
            <IoIosArrowForward onClick={handleForward} className={actualItem === itemsLength - 1 ? "opacity-40" : "cursor-pointer"} size={30} />
        </div>
    )
}
