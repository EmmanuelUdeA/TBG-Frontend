    ...
    return (
        <div className="flex flex-row w-screen h-screen justify-center items-center">
            <section className="flex flex-col w-1/2 h-full justify-center items-center">
                {product && <img className="flex flex-col justify-center items-center w-5/6 h-11/12" alt="product" src={product.front_image}/>}
            </section>
            <section className="flex flex-col w-1/2 h-full justify-start items-start pl-16 mt-40">
                ...
                <div className="flex flex-col justify-center items-start w-full h-auto mt-10">
                    <label className="flex flex-row justify-start items-center w-full h-auto text-lg">Tallas: </label>
                ...
                <div className="flex flex-col justify-center items-start w-full h-auto mt-10">
                    <label className="flex flex-row justify-start items-center w-full h-auto text-lg">Cantidad: </label>
                ...
                <button className="mt-10 w-2/3 h-16 flex flex-row justify-center items-center bg-black text-white text-lg font-bold rounded-2xl">
                    ADD TO CART
                </button>
